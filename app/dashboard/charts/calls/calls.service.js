...
var ChartsCallsService = (function () {
    function ChartsCallsService(http, connectionService) {
        var _this = this;
        this.http = http;
    ...
    ChartsCallsService.prototype.handleError = function (error) {
        console.error(error);
        return Rx_1.Observable.throw(error.json().error || 'Server error');
    };
    ChartsCallsService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [http_1.Http, connection_service_1.ConnectionService])
    ], ChartsCallsService);
    return ChartsCallsService;
}());
exports.ChartsCallsService = ChartsCallsService;
