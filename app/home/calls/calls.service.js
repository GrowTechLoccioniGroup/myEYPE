...
var HomeCallsService = (function () {
    function HomeCallsService(http, connectionService) {
        var _this = this;
        this.http = http;
    ...
    HomeCallsService.prototype.handleError = function (error) {
        console.error(error);
        return Rx_1.Observable.throw(error.json().error || 'Server error');
    };
    HomeCallsService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [http_1.Http, connection_service_1.ConnectionService])
    ], HomeCallsService);
    return HomeCallsService;
}());
exports.HomeCallsService = HomeCallsService;
